...
public class GamePanel extends javax.swing.JPanel implements ScoreChart.Listener {
    ...
    private void initComponents() {
        ...
        add(player1NameBox);
        player1NameBox.setBounds(1090, 40, 190, 40);
        ...
        add(currentWins);
        currentWins.setBounds(1090, 0, 180, 40);
        ...
        add(pNameDisplay);
        pNameDisplay.setBounds(1090, 210, 180, 40);
        ...
        add(turnDisplay);
        turnDisplay.setBounds(1090, 150, 180, 40);
        ...
        player2NameBox.setBounds(1090, 90, 190, 40);
		...
		if(!justWon){
			if(falling == false){
				...
				if(turnNum%2 == 0){
					...
					pNameDisplay.setForeground(Color.CYAN);
				}
